...
<head>
    ...
    <title>students Login - Foundation Polytechnic, Ikot Ekpene</title>
                    ...
                    <div class="form-content h-100">
                        <div class="form-items card" style="z-index:100">
                            ...
                            <div class="card-header d-flex flex-wrap">
                                <a href="../index.php" style="z-index: 3;" class="btn p-2 btn-outline-primary mr-auto d-inline-flex align-items-center"><i class="fas fa-home fa-2x" title="home"></i></a><h2 class="mr-auto"> Student Login</h2><div class="ml-auto"></div>
                            </div>
                            <div class="card-body">
                            <form method="post" action="">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div>
                                        <p>Not an Student Yet? <a href="registration.php">Register Here</a></p>
                                    </div>
                                </div>
