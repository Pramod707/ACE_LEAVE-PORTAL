...
<head>
    ...
    <title> Home - ACE LEAVE PORTAL</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-custom sticky sticky-dark nav-light">
        <div class="container">
            ...
            <a class="navbar-brand logo" href="index.html">
                <img src="images/image.png" alt="" class="logo-dark" height="50">
                <img src="images/image.png" alt="" class="logo-light" height="100">
            </a>
                ...
                <ul class="navbar-nav ml-auto navbar-center" id="mySidenav">
                    <li class="nav-item active">
                        <a href="#home" class="nav-link">Home</a>
                                   ...
                                   <li class="nav-item">
                        <a href="Account/registration.php" class="nav-link">students Registration</a>
                    </li>
                    <li class="nav-item">
                        <a href="Employee/index.php" class="nav-link">students Dashboard</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="hero-title">
                    <h1 class="hero-7-title">
                        <span class="text-wrapper">
                            <span class="text-light font-weight-normal">ACE LEAVE PORTAL </span>                        </span>                    </h1>
                    <p class="text-light-70 mb-4 pb-2">
                    The ACE Leave Portal automates leave requests, approvals, and tracking.

The system offers a user-friendly interface for both students and faculty.

Features include leave balance tracking, calendar view, and email notifications.
achievements.
