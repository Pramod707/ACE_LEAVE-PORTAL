                        ...
                        <div>
                            ...
                            <div class="ibox-content profile-content">
                                <h4><strong><?php echo $fullname ;?></strong></h4>
                                 <h5><strong>Student ID</strong>: <?php echo $employeeID ;?></h5>
                                ...
                                <div class="feed-activity-list">
                                  ...
                                  <div class="feed-element">
                                    ...
                                    <div class="feed-element">
                                        ...
                                        <div class="media-body ">
                                            <small class="pull-right text-navy"></small>
                                            <strong>Student Type :</strong>                    <?php echo $rowaccess['employee_type'];   ?>  <br>
                                        </div>
                                    </div>
                                    <div class="feed-element">
                                        <a href="#" class="pull-left">
                                        ...
                                        <div class="media-body ">
                                            <small class="pull-right text-navy"></small>
                                            <strong>CGP :</strong>                   <?php echo number_format((float) $basic_salary, 2); ?>  <br>
                                        </div>
                                    </div>
                                    <div class="feed-element">
                                        <a href="#" class="pull-left">
                                        ...
                                        <!-- <div class="media-body ">
                                            <small class="pull-right text-navy"></small>
                                            <strong>Gross Pay :</strong>                    <?php echo number_format((float) $gross_pay, 2); ?>  <br>
                                        </div> -->
                                    </div>
                                    <div class="feed-element">
                                        <a href="#" class="pull-left">
