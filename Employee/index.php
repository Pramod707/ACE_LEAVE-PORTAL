...
<head>
    ...
    <title>Students Dashboard|<?php echo $sitename ;?></title>
            ...
            <div class="wrapper wrapper-content">
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5><span class="label label-info pull-right">Student ID</span>
                                </h5>
                            </div>
                    ...
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5><span class="label label-info pull-right"></span>
                                </h5>
                            </div>

                            <!-- <div class="ibox-content">
                                <h3 class="no-margins"><?php echo number_format((float) $basic_salary, 2); ?>
                                </h3>
                                <small> </small>
                            </div>  -->
                        </div>
                    ...
                    <!-- <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            ...
                            <!-- <div class="ibox-content">
                                <h3 class="no-margins"><?php echo number_format((float) $gross_pay, 2); ?>
                                </h3>
                                <small> </small>
                            </div> -->
                        </div>
